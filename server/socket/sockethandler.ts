...
import { addStatistics, editGame, runFunctionOnGame } from '../controllers/gamestats.controller';
import { MSGPromotion, MSGProposeDraw,  MSGConcede, 
        MSGMoveVerified, MSGDrawDeclined, MSGDrawAccepted, 
        MSGMove, MSGInitiate } from '../../src/gameplay/createsocket'
import {Server, Socket} from 'socket.io'


const enableVerification = (io: Server) => {
...
const startSocket = (io: Server) => {
    ...
    io.on('connection', (client: Socket) => {
        ...
        client.on("draw_accepted", (msg: MSGDrawAccepted) => {
          let gameasjson = JSON.parse(msg.gameasjson)
  ...
  export {startSocket, enableVerification}